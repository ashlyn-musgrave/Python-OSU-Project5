...
# Description: This code demonstrates the implementation of a Dynamic Array
...
class DynamicArray:
    ...
    def pop(self) -> object:
        ...
        # Raises DynamicArrayException if the array is empty.
        if self.is_empty():
            raise DynamicArrayException("Cannot pop from an empty array")

        # Get the last element from the array
        popped_element = self._data[self._size - 1]

        # Set the last element to None and decrement the size
        self._data[self._size - 1] = None
        self._size -= 1
